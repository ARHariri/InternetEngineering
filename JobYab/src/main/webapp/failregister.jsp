<%-- 
    ...
    Created on : May 17, 2016, 3:43:46 PM
    Author     : Ali
--%>
    ...
    <body>
		...
		<div class="row">
			...
			<div class="ui negative message persian-label persian-text" style="size: 40px;">
                            ...
                            <p>لطفا اطلاعات وارد شده را کنترل نمایید</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <form action="index.jsp" method="get">
                        <div class="form-group form-group-lg">
                            <div class="col-lg-12">
                                <input type="submit" class="form-control btn btn-danger persian-label persian-btn" value="ثبت نام" id="submitRegisterBtn" />
                            </div>
                        </div>
                    </form>
                </div>
