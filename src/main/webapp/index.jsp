<%-- 
    Document   : index
    Created on : May 10, 2016, 4:11:39 PM
    Author     : Ali
--%>
...
<body>
		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<div class="navbar-collapse collapse">
					<form name="loginForm" class="navbar-form navbar-right" action="MainPage.jsp" method="post">
	...
	<div class="container-fluid" style="padding: 60px;">
		<div class="row">
			<div class="col-sm-6">
				<form class="form-horizontal persian-form" action="#" onsubmit="return CheckValidation();" method="post">
